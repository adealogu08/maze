...
display.set_caption("Close window")
...
packman = Player('hero.png', 1, win_height - 80, 3)
monster = Enemy('cyborg.png', win_width - 80, 280, 2)
final = GameSprite('treasure.png', win_width - 120, win_height - 80, 0)

w1 = Wall(204, 0, 0, 100, 20, 450, 10)
w2 = Wall(204, 0, 0, 100, 480, 350, 10)
w3 = Wall(204, 0, 0, 100, 20, 10, 380 )
w4 = Wall(204, 0, 0, 200, 130, 10, 350)
w5 = Wall(204, 0, 0, 450, 130, 10, 360)
w6 = Wall(204, 0, 0, 300, 20, 10, 350)
w7 = Wall(204, 0, 0, 390, 120, 130, 10)
